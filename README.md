...
Basics of CNN , how CNN learns , how different channels are formed , how DNN make sense of the inputs it gets (Features -> Edges & Gradients -> Patterns -> Part of Objects and Objects ) . Please see below
